    ...
    use: [
        ...
        'spoiler', {
          ...
          render (tokens, idx) {
            ...
            if (tokens[idx].nesting === 1) {
              // opening tag
              return '<details class="custom-block spoiler"><summary>' + m[1] + '</summary>\n'
            } else {
              // closing tag
              return '</details>\n'
            }
      ...
      [
        ...
        'warning', {
          ...
          render (tokens, idx) {
            if (tokens[idx].nesting === 1) {
              const icon = `<i class="markdown-it-vue-alert-icon markdown-it-vue-alert-icon-warning">
      ...
      [
        ...
        'info', {
          ...
          render (tokens, idx) {
            if (tokens[idx].nesting === 1) {
              const icon = `<i class="markdown-it-vue-alert-icon markdown-it-vue-alert-icon-info">
      ...
      [
        ...
        'error', {
          ...
          render (tokens, idx) {
            if (tokens[idx].nesting === 1) {
              const icon = `<i class="markdown-it-vue-alert-icon markdown-it-vue-alert-icon-error">
